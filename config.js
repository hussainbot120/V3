...
global.email = "x3hussainbot120@gmail.com";
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://i.imgur.com/5p61GEZ.jpeg";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`𝙷𝚄𝚂𝚂𝙰𝙸𝙽-V2™`",
  author: process.env.PACK_AUTHER || "𝗛𝗨𝗦𝗦𝗔𝗜𝗡-V2",
  packname: process.env.PACK_NAME || "A N I T A",
  botname: process.env.BOT_NAME || "𝗛𝗨𝗦𝗦𝗔𝗜𝗡-V2",
